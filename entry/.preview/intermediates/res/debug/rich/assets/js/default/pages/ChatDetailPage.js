...
/*!******************************************************************************************!*\
  !*** D:\code\HarmonyOS-WeChat\entry\src\main\ets\default\pages\ChatDetailPage.ets?entry ***!
  \******************************************************************************************/
...
class ChatDetailPage extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        super(compilerAssignedUniqueChildId, parent);
        this.WeChatImage = router.getParams().WeChatImage;
        this.WeChatName = router.getParams().WeChatName;
        this.ChatInfo = router.getParams().ChatInfo;
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params) {
        if (params.WeChatImage !== undefined) {
    ...
    render() {
        Column.create();
        Column.debugLine("pages/ChatDetailPage.ets(12:5)");
        Column.height("100%");
        let earlierCreatedChild_2 = this.findChildById("2");
        if (earlierCreatedChild_2 == undefined) {
            View.create(new CommonStyle_1.WeChatTitle("2", this, { text: this.WeChatName }));
        }
        else {
        ...
        if (earlierCreatedChild_3 == undefined) {
            View.create(new LeftDialogBox("3", this, { imageSrc: this.WeChatImage, text: "我们来玩听歌词，猜歌名的游戏吧！" }));
        }
        else {
            earlierCreatedChild_3.updateWithValueParams({
                imageSrc: this.WeChatImage, text: "我们来玩听歌词，猜歌名的游戏吧！"
            });
        ...
        if (earlierCreatedChild_4 == undefined) {
            View.create(new RigthDialogBox("4", this, { imageSrc: "person (1).jpg", text: "好呀，你唱我来猜吧~" }));
        }
        else {
            earlierCreatedChild_4.updateWithValueParams({
                imageSrc: "person (1).jpg", text: "好呀，你唱我来猜吧~"
            });
        ...
        if (earlierCreatedChild_5 == undefined) {
            View.create(new LeftDialogBox("5", this, { imageSrc: this.WeChatImage, text: this.ChatInfo }));
        }
        else {
            earlierCreatedChild_5.updateWithValueParams({
                imageSrc: this.WeChatImage, text: this.ChatInfo
            });
        ...
        if (earlierCreatedChild_6 == undefined) {
            View.create(new RigthDialogBox("6", this, { imageSrc: "person (1).jpg", text: "哈哈哈，这不是我偶像的歌曲吗，哈哈哈~" }));
        }
        else {
            earlierCreatedChild_6.updateWithValueParams({
                imageSrc: "person (1).jpg", text: "哈哈哈，这不是我偶像的歌曲吗，哈哈哈~"
            });
        ...
        if (earlierCreatedChild_7 == undefined) {
            View.create(new RigthDialogBox("7", this, { imageSrc: "person (1).jpg", text: "周杰伦  " + this.WeChatName }));
        }
        else {
            earlierCreatedChild_7.updateWithValueParams({
                imageSrc: "person (1).jpg", text: "周杰伦  " + this.WeChatName
            });
        ...
        if (earlierCreatedChild_8 == undefined) {
            View.create(new LeftDialogBox("8", this, { imageSrc: this.WeChatImage, text: "哈哈哈，你好聪明，猜对了！" }));
        }
        else {
            earlierCreatedChild_8.updateWithValueParams({
                imageSrc: this.WeChatImage, text: "哈哈哈，你好聪明，猜对了！"
            });
...
class LeftDialogBox extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        super(compilerAssignedUniqueChildId, parent);
        this.imageSrc = undefined;
        this.text = undefined;
    ...
    render() {
        Row.create();
        Row.debugLine("pages/ChatDetailPage.ets(30:5)");
        Row.width('100%');
        Row.margin({ top: '20px', bottom: '20px' });
        Row.alignItems(VerticalAlign.Top);
        Image.create($rawfile(this.imageSrc));
        Image.debugLine("pages/ChatDetailPage.ets(31:7)");
        Image.width('120px');
        Image.height('120px');
        Image.margin({ left: '10px', right: '10px' });
        Text.create(this.text);
        Text.debugLine("pages/ChatDetailPage.ets(32:7)");
        Text.fontSize('14fp');
        Text.backgroundColor("#cccccc");
        Text.padding(10);
        Text.borderRadius(10);
        Text.margin({ right: '280px' });
        Text.pop();
        Row.pop();
    }
}
class RigthDialogBox extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        super(compilerAssignedUniqueChildId, parent);
        this.imageSrc = undefined;
        this.text = undefined;
    ...
    render() {
        ...
        Flex.debugLine("pages/ChatDetailPage.ets(52:5)");
        Flex.margin({ top: '20px', bottom: '20px' });
        Image.create($rawfile(this.imageSrc));
        Image.debugLine("pages/ChatDetailPage.ets(53:7)");
        Image.width('120px');
        Image.height('120px');
        Image.margin({ left: '10px', right: '10px' });
        Image.objectFit(ImageFit.Contain);
        Flex.create({ direction: FlexDirection.RowReverse, justifyContent: FlexAlign.Start });
        Flex.debugLine("pages/ChatDetailPage.ets(59:7)");
        Text.create(this.text);
        Text.debugLine("pages/ChatDetailPage.ets(60:9)");
        Text.fontSize('14fp');
        Text.backgroundColor("#1dde40");
        Text.padding(10);
        Text.borderRadius(10);
